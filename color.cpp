/* MIT code copied & modified from the Fog graphics library */
#include "color.h"
#include <stddef.h>
#include <stdint.h>
#include <string.h>
...
Color colorFromString(const char *name_or_rgb) {
	if (name_or_rgb[0] == '#') {
		...
		unsigned r,g,b;
		if (sscanf(name_or_rgb, "rgb(%u,%u,%u)", &r,&g,&b)!=3) return Color(255,255,255,255);
		return Color(r,g,b,0xFF);
	}
	return colorFromName(name_or_rgb);
}
